            ...
            {data ? (
              ...
              <form className="space-y-4 md:space-y-6" onSubmit={handleFormSubmit}>
                ...
                <input
                  ...
                  onChange={handleChange}
                  class="bg-gray-50  text-gray-900 rounded-lg block w-full p-2.5 dark:bg-gray-800 dark:placeholder-gray-400 dark:text-white mb-6"
                />
                </div>
                <button
                  className="bg-red-700 hover:bg-red-500 text-white py-2 px-4 rounded-lg w-full"
